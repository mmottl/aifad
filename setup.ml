...
(* OASIS_START *)
(* DO NOT EDIT (digest: 26f7d4f65d96160d31ad5f48f17b8f4c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://bitbucket.org/mmottl/aifad";
          synopsis =
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Hg;
                      src_repo_location =
                        "ssh://hg@bitbucket.org/mmottl/aifad";
                      src_repo_browser =
                        Some "https://bitbucket.org/mmottl/aifad";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\136_³\005Ý\006n\146\018úýqç\156p\140";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
